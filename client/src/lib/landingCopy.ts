...
const en: Copy = {
  ...
  tryFree: 'Try VoTask Free', joinCode: 'Join with a code',
...
const hi: Copy = {
  ...
  tryFree: 'VoTask मुफ़्त आज़माएँ', joinCode: 'कोड से जुड़ें',
...
const te: Copy = {
  ...
  tryFree: 'VoTask ఉచితంగా ప్రయత్నించండి', joinCode: 'కోడ్‌తో చేరండి',
