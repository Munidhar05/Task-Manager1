...
//
// Status changes pay NOTHING. They used to pay +1, but dragging a card between
// columns is the cheapest action in the app and can be repeated on the same task
